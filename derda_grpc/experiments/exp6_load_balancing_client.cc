...
void doWork() {
  while (!jobQueue.empty()) {
    ...
    // sleep(1);
    start_test(work, "/global/scratch/users/satishp/data/cemet_data");
...
int main(int argc, char** argv) {
  ...
  // jobQueue.push("Work 1");
  // jobQueue.push("Work 2");
  // jobQueue.push("Work 3");
  // jobQueue.push("Work 4");
  // jobQueue.push("Work 5");
  // jobQueue.push("Work 6");
  // jobQueue.push("Work 7");
  // jobQueue.push("Work 8");
  // jobQueue.push("Work 9");
  ...
  thread thread2(doWork);
  thread thread3(doWork);
  thread thread4(doWork);
  thread thread5(doWork);
  thread thread6(doWork);
  thread thread7(doWork);
  thread thread8(doWork);
  ...
  cout << "Total Time:" << total_intersect_time << endl;
