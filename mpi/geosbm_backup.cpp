...
#define MAX_GEOM_NUMBER 1000000
...
int iterate_tree(char *filename)
{
    initGEOS(geos_message_handler, geos_message_handler);
...
int query(char *filename)
{
    ...
    {
        GEOSSTRtree_query(tree, geoms[i], query_callback, geoms[i]);
    }
...
int intersect(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], intersect_callback, geoms[i]);
    }
...
int overlap(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], overlap_callback, geoms[i]);
    }
...
int touch(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], touch_callback, geoms[i]);
    }
...
int cross(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], cross_callback, geoms[i]);
    }
...
int contain(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], contain_callback, geoms[i]);
    }
...
int equal(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], equal_callback, geoms[i]);
    }
...
int equal_exact(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], equal_exact_callback, geoms[i]);
    }
...
int cover(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], cover_callback, geoms[i]);
    }
...
int covered_by(char *filename)
{
    ...
    for (int i = 0; i < index; i += 10)
    {
        GEOSSTRtree_query(tree, geoms[i], covered_by_callback, geoms[i]);
    }
...
double select_test(char *name, int (*test_function)(char *), char *filename, int n)
{
    double time_arr[n];
    for (int i = 0; i < n; i++)
    {
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    double create_time = select_test("Create", &create_tree, filename, n);
    double iterate_time = select_test("Iterate", &iterate_tree, filename, n);
    double query_time = select_test("Query", &query, filename, n);
    double intersect_time = select_test("Intersect", &intersect, filename, n);
    double overlap_time = select_test("Overlap", &overlap, filename, n);
    double touch_time = select_test("Touch", &touch, filename, n);
    double cross_time = select_test("Cross", &cross, filename, n);
    double contain_time = select_test("Contain", &contain, filename, n);
    double equal_time = select_test("Equal", &equal, filename, n);
    double equal_exact_time = select_test("Equal Exact (0.3)", &equal_exact, filename, n);
    double cover_time = select_test("Cover", &cover, filename, n);
    double covered_by_time = select_test("Covered By", &covered_by, filename, n);
